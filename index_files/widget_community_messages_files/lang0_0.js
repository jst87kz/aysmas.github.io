...
audio_do_you_want_flash='Хотите перейти на страницу установки плеера?';
audio_you_need_flash='Для того чтобы воспользоваться аудиосервисом, Вам необходимо установить Flash Player.';
box_cancel='Отмена';
box_close='Закрыть';
...
global_article_added_to_faves='Статья добавлена в {link}Закладки{/link}';
global_article_carousel_counter='{counter} из {total}';
global_attach_max_n_files=['','Вы можете прикрепить к сообщению не более {count} файла.','Вы можете прикрепить к сообщению не более {count} файлов.','Вы можете прикрепить к сообщению не более {count} файлов.'];
global_audio_ad='Реклама';
global_audio_flash_required='Для прослушивания музыки необходим Flash Player. <br>Вы можете установить его {link}здесь{/link}.';
global_audio_next='Следующая аудиозапись';
global_audio_only_with_subscription_btn='Узнать больше';
global_audio_only_with_subscription_text='Так решил артист или его представитель. Купите подписку и получите доступ к расширенному каталогу музыки';
global_audio_only_with_subscription_title='Аудиозапись доступна только по подписке';
global_audio_pause='Приостановить';
global_audio_play='Воспроизвести';
global_audio_playlist='Аудиоплейлист';
global_audio_prev='Предыдущая аудиозапись';
global_audio_replace='Заменить';
global_audio_seek_back='Промотать назад';
global_audio_seek_forward='Промотать вперёд';
global_audio_volume_down='Тише';
global_audio_volume_up='Громче';
global_back='Назад';
global_box_confirm_title='Подтверждение';
...
global_dropdown_aria_label_selected='Выбрано: ';
...
global_notifications_settings='Настройки';
global_notifitications='Уведомления';
...
global_recent_search_history='Недавние запросы';
...
audio_claimed_future='Купите подписку и получите доступ к расширенному каталогу музыки';
audio_claimed_future_title='Аудиозапись доступна только по подписке';
...
audio_claimed_text_geo='Аудиозапись {audio} недоступна для прослушивания в Вашем регионе. <br><br>Вы можете {delete_link}.';
...
audio_clear_current_playlist='Очистить плейлист';
...
audio_need_flash_title='Необходим Flash Player';
...
audio_no_rec_load_msg='Здесь Вы можете хранить Ваши аудиозаписи.<br>Чтобы загрузить первую аудиозапись, {link}нажмите здесь{/link}.';
...
audio_row_action__add_pl='Добавить в плейлист';
audio_row_action__share='Поделиться';
...
apps_games_of_group='Игры сообщества';
apps_game_added_to_group='Игра добавлена в сообщество';
...
apps_game_settings='Настройки игры';
...
apps_no_games_in_group='В сообществе не подключено ни одной игры.';
...
video_live_stream_create_unexpected_error='Произошла непредвиденная ошибка. Попробуйте позже.';
...
groups_app_edit_box_title='Настройки приложения';
...
payments_method_by_card_descr='Mastercard, Maestro, Visa, Мир';
...
profile_enter_post='Добавить запись…';
...
profile_oph_crop_desc='Осталось выбрать область для маленьких фотографий.<br>Выбранная миниатюра будет использоваться в новостях, личных сообщениях и комментариях.';
// section = 31; version = 320;
...
wall_post_info_anon='Кто-то из Ваших друзей';
...
mobile_audio_count=['','%s аудиозапись','%s аудиозаписи','%s аудиозаписей'];
mobile_edit_country_null='Не выбрана';
mobile_fave_market='Добавить в закладки';
mobile_fave_post='Прочитать позже';
mobile_fave_video='Посмотреть позже';
mobile_flood_detected='Вы попытались загрузить более одной однотипной страницы в секунду. Вернитесь назад и повторите попытку.';
mobile_friends_feed_recom_accept_request='ДОБАВИТЬ';
mobile_friends_feed_recom_got_notification='Заявка отправлена';
mobile_like_publish_back='Вернуться к оригиналу »';
mobile_mail_date=['','{day} {month} {year}','вчера','сегодня','завтра'];
mobile_mail_hours_ago=['','%s час назад','%s часа назад','%s часов назад'];
mobile_mail_im_joined_chat_from_invitation=['','{from} присоединился к беседе','{from} присоединилась к беседе'];
mobile_mail_just_now='только что';
mobile_mail_last_activity_tip=['','был в сети {time}','была в сети {time}'];
mobile_mail_messages_selected=['','Выбрано {count} сообщение','Выбрано {count} сообщения','Выбрано {count} сообщений'];
mobile_mail_mins_ago=['','%s минуту назад','%s минуты назад','%s минут назад'];
mobile_mail_N_members=['','%s участник','%s участника','%s участников'];
mobile_mail_not_found='По Вашему запросу не найдено ни одного сообщения';
mobile_mail_no_important='У Вас нет важных сообщений.';
mobile_mail_no_peers='Ни одного диалога не найдено';
mobile_mail_no_unreaded='У Вас нет непрочитанных сообщений.';
mobile_mail_online='онлайн';
mobile_mail_search_only_messages='Искать в личных сообщениях';
mobile_mail_short_date_time=['','{day} {month} в {hour}:{minute}','вчера в {hour}:{minute}','сегодня в {hour}:{minute}','завтра в {hour}:{minute}'];
mobile_mail_typing_1_short='печатает';
mobile_msg_cant_send_msg='Вы не можете отправить сообщение этому пользователю, так как он ограничивает круг лиц, которые могут присылать ему сообщения.';
mobile_msg_cant_send_msg2='Вы не можете отправить сообщение этому пользователю, так как он ограничивает круг лиц, которые могут присылать ему сообщения.';
mobile_msg_cant_send_notfriend='Сообщение не может быть отправлено, так как Вы не состоите в друзьях у этого пользователя.';
mobile_msg_mail_message_sent='Сообщение отправлено.';
mobile_msg_mail_not_friend_in_chat='Вы не можете создать беседу с человеком, который не является Вашим другом.';
mobile_msg_mail_privacy_error='Вы не можете отправить сообщение этому пользователю, поскольку он ограничивает круг лиц, которые могут присылать ему сообщения.';
mobile_msg_mail_server_error='Сообщение не отправлено из-за ошибки на сервере.';
mobile_msg_mail_spam_chain_detected='Вы только что попытались отправить сообщение, относящееся к так называемым «письмам-цепочкам». Такие письма загружают сервер и обычно не несут смысловой нагрузки (ложные сообщения о «вирусах», послания, заканчивающиеся угрозами и т.д.). Отсылка таких писем на нашем сайте не приветствуется.';
mobile_msg_mail_too_many_recipients='Сообщение не может быть отправлено, так как Вы разослали слишком много сообщений за последнее время.';
mobile_msg_no_rights='У Вас недостаточно прав для совершения этого действия.';
mobile_msg_reported='Жалоба отправлена.';
mobile_photos_albums_edit_album_btn='Сохранить';
mobile_photos_edit_save_btn='Сохранить';
mobile_playlist_add='Добавить';
mobile_playlist_added='Добавлен';
mobile_playlist_play='Воспроизвести';
mobile_profile_status_hours_ago=['','%s час назад','%s часа назад','%s часов назад'];
mobile_profile_status_just_now='только что';
mobile_profile_status_mins_ago=['','%s минуту назад','%s минуты назад','%s минут назад'];
mobile_profile_status_word_hours_ago=['','час назад','два часа назад','три часа назад','четыре часа назад','пять часов назад'];
mobile_profile_status_word_mins_ago=['','минуту назад','две минуты назад','три минуты назад','4 минуты назад','5 минут назад'];
mobile_profile_work_label='Место работы:';
mobile_unfave_market='В закладках';
mobile_unfave_post='Убрать из закладок';
mobile_unfave_video='Убрать из закладок';
mobile_unknown_error='Неизвестная ошибка';
mobile_wall_publish_postponed='Опубликовать сейчас';
mobile_zphoto_save_btn='Сохранить';
// section = 61; version = 78;

bugs_invite_X_members=['','Пригласить %s участника','Пригласить %s участников','Пригласить %s участников'];
bugs_search_results='Результаты поиска';
bugs_t_notify_found='Рассылка';
bugs_t_notify_recipients_count=['','Сообщение отправится %s получателю','Сообщение отправится %s получателям','Сообщение отправится %s получателям'];
bugs_t_report_export_button='Экспортировать';
// section = 63; version = 13;
